    ...
    grunt.initConfig({
        ...
        watch: {
            dev: {
                ...
                tasks: [ 'jshint','html2js:dist','copy:main', 'concat:dist', 'clean:temp','cssmin', 'bless:check'],
                options: {
                    atBegin: true
                }
            },
            min: {
                files: [ 'Gruntfile.js', 'app/*.js', '*.html','styles/*.scss' ],
                tasks: [ 'jshint','html2js:dist','copy:main', 'concat:dist', 'clean:temp', 'uglify:dist','cssmin', 'bless:check'],
                options: {
                    atBegin: true
                }
            }
